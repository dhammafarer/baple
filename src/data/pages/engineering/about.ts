...
export const frontmatter: AboutPage = {
  ...
  sections: {
    ...
    about2: {
      ...
      body: [
        "En la actualidad, Baple Engineering está especializada en ofrecer bajo demanda soluciones especiales, y/o a medida para proyectos de diversa índole, ya sea electrónica, ingeniería, construcción civil, transporte de mercancias peligrosas.",
    ...
    advantages: {
      heading: "Ventajas de Baple Engineering",
      body: [
